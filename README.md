...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
 ...
 | [Diffusion Models in object detection: A  survey.](user_requests/Diffusion_Models_in_object_detection__A__survey..pdf) | Diffusion Models, remote sensing, synthetic aperture radar, feature representation, object recognition |
 ...
 | [Evolving robotic systems with integrated advanced sensors and machine learning](user_requests/Evolving_robotic_systems_with_integrated_advanced_sensors_and_machine_learning.pdf) | multisensory, multimodal sensor, advanced sensor, design principles of sensors, materials, structure design, fabriaction, sensing mechanisms, cross-modal communication and learning, machine learning hardware and algorithms, Integration, embedded ML systems, Neuromorphic sensing and computing systems, Virtual Reality (VR) and Augmented Reality (AR), Smart manufacturin, Healthcare, Autonomous vehicles, Large scale IoTs, Robotics |
 ...
 | [Speech-based Depression Recognition: A Survey](user_requests/Speech-based_Depression_Recognition__A_Survey.pdf) | Depression, Speech, Deep Learning |
